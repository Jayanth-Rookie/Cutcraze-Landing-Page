          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <Mail className="w-6 h-6 text-cutcraze-teal flex-shrink-0" />
                <div>
                  <h4 className="font-medium mb-1">Email Us</h4>
                  <p className="text-gray-300">hello@cutcraze.com</p>
                  <p className="text-gray-300">support@cutcraze.com</p>
                </div>
              </div>
              
              <div className="flex items-start gap-4">
                <Phone className="w-6 h-6 text-cutcraze-teal flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <MapPin className="w-6 h-6 text-cutcraze-teal flex-shrink-0" />
                <div>
                  <h4 className="font-medium mb-1">Visit Us</h4>
                  <p className="text-gray-300">123 Creative Studio Lane</p>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-white/5 border border-white/10 text-white rounded-lg block w-full p-3 focus:outline-none focus:ring-2 focus:ring-cutcraze-teal"
                ...
                <button
                  ...
                  className="w-full bg-cutcraze-teal hover:bg-cutcraze-teal/90 text-white py-3 px-6 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
                >
                  {isSubmitting ? (
                    <>
